...
contract Token is Initializable, IERC20Upgradeable, OwnableUpgradeable {
    ...
    function initialize(
        ...
        buyBurnFee = _fees[7];
        require(
            sellLiquidityFee + sellMarketingFee + sellRewardFee + sellBurnFee <=
                300
        );
        require(
            buyLiquidityFee + buyMarketingFee + buyRewardFee + buyBurnFee <= 300
        );
    ...
    function _transferStandard(
        ...
        if (tLiquidity > 0 || tMarketing > 0 || tBurn > 0) {
            _takeLiquidity(tLiquidity, tMarketing, tBurn);
        }
        if (tFee > 0) {
        ...
        )
    {
        ...
        tAmounts[3] = calculateMarketingFee(tAmount);
        tAmounts[4] = calculateBurnFee(tAmount);
        tAmounts[0] = tAmount -
            tAmounts[1] -
            tAmounts[2] -
            tAmounts[3] -
    ...
    function _takeLiquidity(
        ...
        uint256 tTmp = tLiquidity + tMarketing + tBurn;
    ...
    function updateLiquidityFee(
        ...
        require(
            _buyLiquidityFee + buyMarketingFee + buyRewardFee + buyBurnFee <=
                300,
            "buy fee <= 30%"
        );
    ...
    function updateMarketingFee(
        ...
        require(
            _buyMarketingFee + buyLiquidityFee + buyRewardFee + buyBurnFee <=
                300,
            "buy fee <= 30%"
        );
        ...
        onlyOwner
    {
        ...
        require(
            _buyRewardFee + buyLiquidityFee + buyMarketingFee + buyBurnFee <=
                300,
            "buy fee <= 30%"
        );
        ...
        onlyOwner
    {
        ...
        require(
            _buyBurnFee + buyLiquidityFee + buyRewardFee + buyMarketingFee <=
                300,
            "buy fee <= 30%"
        );
